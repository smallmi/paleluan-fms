...
class AppProject(models.Model):
    ...
    app_name_en = models.CharField(max_length=255, null=True, blank=True, verbose_name=u'英文名称')
    app_name_cn = models.CharField(max_length=255, null=True, blank=True, verbose_name=u'中文名称')
    app_type = models.CharField(max_length=255, null=True, blank=True, verbose_name=u'应用类型')
    platform = models.ForeignKey(Platform, blank=True, null=True, related_name='servers', on_delete=models.SET_NULL,
                                 verbose_name=u'所属平台')

    git_url = models.CharField(max_length=255, null=True, blank=True, verbose_name=u'Git 地址')
    # git_branch = models.CharField(max_length=255, null=True, blank=True, verbose_name=u'Git分支')
    git_properties = models.CharField(max_length=255, null=True, blank=True, verbose_name=u'配置文件')
...
class ReleasePlan(models.Model):
    ...
    app = models.ForeignKey(AppProject, blank=True, null=True, related_name='apps', on_delete=models.SET_NULL,
                            verbose_name=u'发布应用')
    git_branch = models.CharField(max_length=255, null=True, blank=True, verbose_name=u'CommitID')
    app_version = models.CharField(max_length=255, null=True, blank=True, verbose_name=u'代码版本')
