...
class Server(models.Model):
    # 服务器信息
    in_ip = models.CharField(max_length=255, null=True, blank=True, unique=True, verbose_name=u'内网地址')  # 内网ip
    ...
    ex_ip = models.CharField(max_length=255, null=True, blank=True, verbose_name=u'外网地址')  # 弹性ip
    project_name = models.CharField(max_length=255, null=True, blank=True, verbose_name=u'项目名称')
    host_name = models.CharField(max_length=255, null=True, blank=True, verbose_name=u'主机名称')
    service_name = models.CharField(max_length=255, null=True, blank=True, verbose_name=u'服务名称')
